...
class evaluate:
    ...
    def sweep(rocket_name):
        ...
        payload_range=[70e3]#np.arange(50e3,100e3,10e3)
        tank_diameter_range=np.arange(6,9,0.5)
        boostback_1_range=[1500]#[1500,2000]
        boostback_2_range=[2000]#[2000,2500]
        n_iter=len(payload_range)*len(tank_diameter_range)*len(boostback_1_range)*len(boostback_2_range)
        sr_no=1
            ...
            for tank_diameter in tank_diameter_range:
                for boostback_1 in boostback_1_range:
                    for boostback_2 in boostback_2_range:
                        ...
                        out_dict["Tank Diameters"]=tank_diameter
